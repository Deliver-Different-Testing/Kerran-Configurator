...
// are a later slice.
//
// Phase 5+31 R2: the per-method NpFeatureConfig.CanManageApplicants gate
// was retired here (matrix replaces NpFeatureConfig as the visibility
// source). Sidebar already gates UI access via the courier-recruitment
// feature key; API-level access remains gated by the 9 NP role policies
// (NpManageApplicants etc.) wired in 5+28b §B.2. The service itself no
