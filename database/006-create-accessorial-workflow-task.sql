...
BEGIN
    CREATE TABLE AccessorialWorkflowTask (
        ...
        AccessorialChargeId INT NOT NULL,       -- FK to AccessorialCharge
        ...
        CONSTRAINT FK_AWT_AccessorialCharge FOREIGN KEY (AccessorialChargeId) REFERENCES AccessorialCharge(Id),
        CONSTRAINT FK_AWT_EventType FOREIGN KEY (EventTypeId) REFERENCES TucEventType(EventTypeId)
    );
