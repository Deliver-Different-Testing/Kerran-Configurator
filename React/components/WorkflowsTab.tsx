                      ...
                      <tr key={idx}>
                        ...
                        <td>
                          <input
                            ...
                            onChange={(e) =>
                              updateStep(idx, 'eventTypeId', parseInt(e.target.value) || 0)
                            }
                            style={{ width: 80 }}
                          />
                        </td>
                        <td>
                          <input
                            className="form-control form-control-sm"
                            value={step.eventTypeName}
                            onChange={(e) =>
                              updateStep(idx, 'eventTypeName', e.target.value)
                            }
                        ...
                        <td>
                          <select
                            ...
                            onChange={(e) =>
                              updateStep(idx, 'statusName', e.target.value)
                            }
                          >
                            {STAGES.map((s) => (
